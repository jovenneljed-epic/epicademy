        ...
        <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-900 p-6 sm:p-8 text-white relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-6 border-t border-white/10 text-center">
            ...
            <div className="bg-white/5 rounded-2xl p-2.5">
              ...
              <p className="text-[11px] text-slate-300 mt-0.5 font-medium">Mga Mag-aaral</p>
            </div>

            <div className="bg-white/5 rounded-2xl p-2.5">
              <p className="text-lg font-black text-white">{developer.courses.length} Kurso</p>
              <p className="text-[11px] text-slate-300 mt-0.5 font-medium">Inihahandog</p>
            </div>
            ...
            <div className="bg-white/5 rounded-2xl p-2.5">
              ...
              <p className="text-[11px] text-slate-300 mt-0.5 font-medium">Tapat na Guro</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-8">
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold uppercase tracking-wider text-slate-400">
              Tungkol sa Mentor & Kwalipikasyon
            </h3>
            ...
            <div className="p-3.5 rounded-2xl bg-blue-50/80 border border-blue-100 flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-blue-900">Patunay ng Karanasan at Katapatan sa Pagtuturo</p>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base sm:text-lg font-extrabold text-slate-900 flex items-center gap-2">
                  ...
                  <span>Mga Kursong Inaalok ng Mentor</span>
                </h3>
                <p className="text-xs text-slate-500">
                  Direktang pag-aaral na may mabilis at ligtas na bayaran sa pamamagitan ng GCash, GoTyme Bank, at Maya.
                </p>
              </div>
              <span className="text-xs font-bold text-blue-700 bg-blue-50 px-2.5 py-1 rounded-lg border border-blue-200/80">
                {developer.courses.length} Kurso
              </span>
            </div>
                  ...
                  >
                      ...
                      <div className="sm:text-right shrink-0 flex flex-col sm:items-end justify-between gap-3 border-t sm:border-t-0 pt-4 sm:pt-0 border-slate-100">
                        <div>
                          ...
                          <p className="text-[11px] font-semibold text-emerald-600 flex items-center sm:justify-end gap-1 mt-0.5">
                            <Smartphone className="w-3 h-3" />
                            <span>GCash at GoTyme Bank Ready</span>
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                          ...
                          >
                            <span>Mag-Aral Na • {formatPhp(phpPrice)}</span>
                    ...
                    {course.modules && course.modules.length > 0 && (
                      <div className="mt-4 pt-4 border-t border-slate-100">
                        ...
                        >
                          <span>{isExpanded ? 'Itago' : 'Silipin'} ang Balangkas ng Aralin ({course.modules.length} Modules)</span>
