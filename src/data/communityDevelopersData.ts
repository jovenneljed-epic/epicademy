...
export const COMMUNITY_EVENTS: CommunityEvent[] = [
  ...
  },
  {
    ...
    speaker: {
      name: 'Ronnel M. Aviguetero, CEO and FOUNDER of KEZJED SOLUTIONS',
...
export const COMMUNITY_DEVELOPERS: CommunityDeveloper[] = [
  {
    ...
    studentsCount: 3450,
    coursesCount: 5,
    bio: 'CEO and FOUNDER of KEZJED SOLUTIONS. Full-fledged ICT instructor, TESDA CSS NC II Certified Trainer/Assessor, cloud data architect, drummer & church keyboard mentor, and tech executive dedicated to uplifting aspiring tech and music professionals.',
    ...
    featuredSkillTags: ['TESDA CSS NC II', 'Computer Hardware', 'Structured Cabling', 'Pinoy Drum Mastery', 'Church Keyboard Mastery', 'Nashville Number System', 'Windows Server AD DS', 'Network Switching', 'Hardware Diagnostics', 'TVET Pedagogy'],
...
export const COMMUNITY_SPACES: CommunitySpace[] = [
  {
    ...
    creatorName: 'Ronnel M. Aviguetero, CEO and FOUNDER of KEZJED SOLUTIONS',
    badge: '★ TESDA NC II',
  ...
  },
  {
    ...
    description: 'Led by Ronnel M. Aviguetero, CEO and FOUNDER of KEZJED SOLUTIONS. Full-stack cloud engineering, faith, and servant leadership in tech.',
    membersCount: 1980,
    priceLabel: 'FREE',
    isVerified: true,
    category: 'community',
...
export const COACHING_PACKAGES: CoachingItem[] = [
  {
    ...
    mentorName: 'Ronnel M. Aviguetero',
    mentorRole: 'CEO and FOUNDER of KEZJED SOLUTIONS',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80',
